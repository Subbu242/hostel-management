...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2022 at 11:28 AM
...
VALUES(null,NEW.course_code,NEW.course_sn,NEW.course_fn,'INSERTED',NOW())
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `delete` BEFORE DELETE ON `courses` FOR EACH ROW INSERT INTO trig_course
VALUES(null,OLD.course_code,OLD.course_sn,OLD.course_fn,'DELETED',NOW())
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update` AFTER UPDATE ON `courses` FOR EACH ROW INSERT INTO trig_course
VALUES(null,NEW.course_code,NEW.course_sn,NEW.course_fn,'UPDATED',NOW())
$$
DELIMITER ;
...
(3, 2, 200, 6000, '2021-12-02 01:30:58'),
...
INSERT INTO `trig_course` (`id`, `course_code`, `course_sn`, `course_fn`, `operation`, `date`) VALUES
(1, 'BB1200', 'BBA', 'Bachelor Of Business Administration', 'INSERTED', '2022-01-28'),
(2, 'BB1200', 'BBA', 'Bachelor Of Business Administration', 'DELETED', '2022-01-28'),
(3, 'BB1200', 'BBA', 'Bachelor Of Business Administration', 'INSERTED', '2022-01-28'),
(4, 'BB1200', 'BBA', 'Bachelor Of Business Administration', 'DELETED', '2022-01-28'),
(5, 'BC36356', 'BCA', 'Bachelor Of Computer Applications', 'UPDATED', '2022-01-28');
...
(4, 10, 'test@gmail.com', '2021-12-06 11:22:47'),
(5, 10, 'test@gmail.com', '2021-12-06 15:37:40'),
(6, 20, 'Benjamin@gmail.com', '2021-12-06 16:40:57'),
(7, 10, 'test@gmail.com', '2021-12-08 07:43:43'),
(11, 20, 'Benjamin@gmail.com', '2022-01-20 07:10:06'),
(13, 10, 'test@gmail.com', '2022-01-20 07:19:58'),
(14, 10, 'test@gmail.com', '2022-01-20 07:28:07');
